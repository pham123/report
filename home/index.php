...
<head>
  ...
  <title><?php echo $oDB->lang('HallaElectronicVina') ?></title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="" Style='background-color:white;'>
        ...
        <div class="sidebar-brand-text mx-3" Style='Color:#22356f;font-size: 3em'><?php echo $oDB->lang('Hev') ?></div>
      </a>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="index.html">
          ...
          <span><?php echo $oDB->lang('HomePage') ?></span></a>
      </li>
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="#">
                  ...
                  <?php echo $oDB->lang('Profile') ?>
                </a>
                <a class="dropdown-item" href="#">
                  <i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i>
                  <?php echo $oDB->lang('Settings') ?>
                </a>
                <a class="dropdown-item" href="#">
                  <i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i>
                  <?php echo $oDB->lang('ActivityLogs') ?>
                </a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="../" data-toggle="modal" data-target="#logoutModal">
                  <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                  <?php echo $oDB->lang('Logout') ?>
                </a>
              </div>
            </li>
          ...
          <div class="row">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"><?php echo $oDB->lang('Notice') ?></h6>
                </div>
                <div class="card-body">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span><?php $oDB->lang('Copyright') ?></span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
