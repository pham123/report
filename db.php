...
$sql[11] = "CREATE TABLE TargetQuantity (
    ...
    ";
$sql[12] = "INSERT INTO TargetQuantity(`LineId`,`TargetQuantityTimes`,`TargetQuantityQty`)
VALUES(1,1,1000)";
